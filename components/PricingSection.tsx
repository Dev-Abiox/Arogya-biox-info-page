    ...
    <div className="relative z-20 py-8 md:py-24 px-6 md:px-12 lg:px-24 flex flex-col justify-center">
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center mb-20 md:mb-32">
          <span className="text-blue-300 text-label-2 font-bold tracking-[0.4em] uppercase mb-6 block font-heading">Commercial Model</span>
          <h2 className="text-h2 md:text-h1 font-light mb-8 font-heading">Flexible <span className="font-medium italic text-blue-300">BioSaaS</span> Model</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12 mb-32">
          <div className="glass-effect p-6 md:p-8 lg:p-12 rounded-2xl md:rounded-[32px] lg:rounded-[40px] border border-blue-400/30 relative overflow-hidden group hover:border-blue-400/50 hover:bg-white/[0.04] hover:-translate-y-2 transition-[border-color,background-color,transform] duration-500">
            <div className="absolute top-0 right-0 bg-blue-400 text-black text-xs md:text-small-label font-bold uppercase tracking-widest px-4 md:px-8 py-2 md:py-3 rounded-bl-2xl md:rounded-bl-3xl group-hover:bg-blue-300 transition-colors font-heading">
          ...
          <div className="flex flex-col justify-center space-y-12 p-4">
            <div className="group hover:-translate-x-1 transition-transform duration-500">
              <h4 className="text-label-1 font-bold uppercase tracking-widest text-blue-300 mb-4 flex items-center gap-3 group-hover:text-blue-400 transition-colors font-heading">
                <span className="w-6 h-[1px] bg-blue-300 group-hover:w-10 transition-[width] duration-500"></span> Onboarding
              </h4>
              <p className="text-body-2 md:text-body-1 text-white/80 leading-relaxed font-light group-hover:text-white transition-colors font-body">System enablement includes secure data mapping, LIS certification, and clinical report template design to match your lab standards.</p>
            </div>
            <div className="group hover:-translate-x-1 transition-transform duration-500">
              <h4 className="text-label-1 font-bold uppercase tracking-widest text-blue-300 mb-4 flex items-center gap-3 group-hover:text-blue-400 transition-colors font-heading">
                <span className="w-6 h-[1px] bg-blue-300 group-hover:w-10 transition-[width] duration-500"></span> Scalability
              </h4>
              <p className="text-body-2 md:text-body-1 text-white/80 leading-relaxed font-light group-hover:text-white transition-colors font-body">Commercial models are tiered based on your laboratory's CBC throughput, ensuring unit economics align with your operational growth.</p>
            </div>
            <div className="group hover:-translate-x-1 transition-transform duration-500">
              <h4 className="text-label-1 font-bold uppercase tracking-widest text-blue-300 mb-4 flex items-center gap-3 group-hover:text-blue-400 transition-colors font-heading">
                <span className="w-6 h-[1px] bg-blue-300 group-hover:w-10 transition-[width] duration-500"></span> Continuous Value
              </h4>
              <p className="text-body-2 md:text-body-1 text-white/80 leading-relaxed font-light group-hover:text-white transition-colors font-body">Subscription includes all algorithm updates, security patches, and regulatory alignment updates as Clinomic Labs evolves.</p>
            </div>
          </div>
        </div>
            ...
            <div className="max-w-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-2 text-body-2 text-white group/item">
