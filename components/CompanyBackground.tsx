    ...
    <div className="relative z-20 py-20 md:py-40 px-6 md:px-12 lg:px-24 flex flex-col justify-center">
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div className="grid grid-cols-1 gap-8 md:gap-12 lg:mt-20">
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-8">
              ...
              <div className="text-right group hover:scale-105 transition-transform duration-300 origin-right h-full flex flex-col items-end justify-between">
                <div className="text-sm md:text-lg lg:text-xl font-bold text-white mb-1 leading-tight">
                  Preventive Health
                </div>
                <div className="text-[7px] md:text-[9px] text-white/80 uppercase tracking-widest font-bold group-hover:text-blue-400 transition-colors">
                  (Upcoming)
                </div>
              </div>
            </div>
            <p className="italic text-blue-300 text-[12px] md:text-[13px] font-medium text-left opacity-80 mt-[-10px] md:mt-[-10px]">"We design every product as a clinical decision support system, not a diagnostic replacement."</p>
          </div>
        </div>
      </div>
    </div>
