      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-24 items-start">
          ...
          <div className="text-left">
            <span className="text-blue-400 text-label-2 md:text-label-1 font-bold tracking-[0.4em] uppercase mb-4 md:mb-8 block font-heading">ABOUT US</span>
            <img
              src="/arogya-logo-full.png"
              alt="Arogya BioX"
              className="h-[24px] md:h-[42px] w-auto mb-6 md:mb-12 object-contain"
            />

            <h2 className="text-2xl md:text-display-1 font-light mb-6 md:mb-12 leading-[1.1] tracking-tight text-white font-heading">
              Transforming <br />
              <span className="font-medium italic text-white/90">Routine Tests</span> <br />
              into Screening Tools.
            </h2>

            <div className="space-y-6 md:space-y-8 text-white/80 text-sm md:text-body-1 lg:text-h3 font-light leading-relaxed max-w-xl font-body">
              <p>
          ...
          {/* Right Column */}
          <div className="flex flex-col gap-8 md:gap-12 mt-8 lg:mt-0">
            {/* Our Approach Card */}
            <div className="glass-effect p-6 md:p-12 rounded-[40px] border border-white/10 md:hover:border-blue-400/30 transition-all duration-500 group">
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={idx} className="flex items-center gap-4 group/item">
                    ...
                    <span className="text-sm md:text-body-1 text-white/90 font-light font-body">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 px-4">
              <div className="flex flex-col items-center gap-2">
                <div className="text-h2 md:text-h2 font-light text-white font-heading tracking-tight text-center">CDSS</div>
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="text-h2 md:text-h2 font-light text-blue-400 font-heading tracking-tight text-center">B12</div>
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="text-h3 md:text-h3 font-light text-white font-heading tracking-tight text-center">Preventive Health</div>
