      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-24 grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="text-left">
            ...
            <div className="space-y-8 text-white/80 text-body-1 font-light leading-relaxed max-w-xl font-body">
              <p>
          ...
          <div className="mt-12 lg:mt-0">
            <div className="glass-effect p-6 md:p-8 lg:p-12 rounded-2xl md:rounded-[32px] lg:rounded-[40px] border border-white/10 hover:border-blue-400/30 hover:bg-white/[0.04] transition-colors duration-500 group">
              ...
              <p className="text-white/90 text-body-1 font-light leading-relaxed mb-10 font-body">
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={idx} className="flex items-start gap-4 group/item">
                    ...
                    <span className="text-body-1 text-white/90 font-light font-body">
                      {item.bold} {item.rest}
                    </span>
                  </li>
                ))}
              ...
              <div className="mt-12">
                {scanResult ? (
                  <div className="reveal revealed">
                    ...
                    <p className="text-body-2 md:text-body-1 text-white/80 font-light leading-relaxed font-body">{scanResult.details}</p>
                    <button onClick={() => {
                      setScanResult(null);
                      setPatientData(generateRandomData());
        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 mb-32">
          <div className="space-y-8 md:space-y-12 reveal-left">
            <div className="group">
              ...
              <p className="text-white font-light text-body-1 md:text-h3 leading-relaxed opacity-80 group-hover:opacity-100 transition-opacity font-body">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="flex items-center gap-3 group/item">
                  ...
                  <span className="text-body-2 md:text-body-1 text-white font-medium group-hover/item:text-blue-200 transition-colors font-body">{item}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto border-t border-white/10 pt-24 text-center">
          <div className="max-w-4xl mx-auto mb-16">
            <span className="text-blue-300 text-label-2 font-bold tracking-[0.4em] uppercase mb-8 block font-heading">Future Roadmap</span>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div key={idx} className="glass-effect p-5 md:p-6 rounded-2xl md:rounded-[32px] lg:rounded-[40px] border border-white/20 hover:border-blue-400/40 hover:-translate-x-1 transition-[border-color,background-color,transform] duration-500 group text-left">
                    ...
                    <span className="text-body-1 text-white/75 font-light group-hover:text-white/95 transition-colors leading-snug font-body">{item.d}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="relative reveal-right stagger-1 h-full">
              <div className="glass-effect h-full min-h-[380px] md:min-h-[480px] rounded-2xl md:rounded-[32px] lg:rounded-[40px] border border-white/10 p-6 md:p-8 lg:p-12 flex flex-col justify-center relative overflow-hidden group hover:border-blue-400/30 hover:bg-white/[0.04] transition-[border-color,background-color,transform] duration-700">
                ...
                <h3 className="text-h2 md:text-h1 font-light mb-8 text-center group-hover:text-white transition-colors font-heading">Screening at the <span className="font-medium">Point of Routine</span></h3>
                <p className="text-white/80 text-body-2 md:text-body-1 font-light text-center leading-relaxed mb-12 group-hover:text-white transition-colors font-body">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="glass-effect p-6 md:p-8 lg:p-12 rounded-2xl md:rounded-[32px] lg:rounded-[40px] border border-white/10 flex flex-col justify-between hover:-translate-y-2 hover:border-blue-400/30 hover:bg-white/[0.04] transition-[border-color,background-color,transform] duration-500 group reveal-left">
              <div>
                ...
                <h3 className="text-h2 md:text-h1 font-light mb-8 transition-colors group-hover:text-blue-100 font-heading">
                ...
                <ul className="space-y-6 mb-10">
                  {[
                    ...
                    <li key={idx} className="group/item">
                      ...
                      <div className="text-body-2 md:text-body-1 text-white/80 font-light leading-relaxed group-hover/item:text-white transition-colors font-body">{item.d}</div>
                    </li>
                  ))}
                </ul>
              </div>
