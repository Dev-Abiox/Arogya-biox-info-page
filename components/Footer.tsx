...
const Footer: React.FC = () => {
    return (
        <div className="mt-8 md:mt-12 pt-4 md:pt-6 border-t border-white/10 flex flex-col items-center justify-center gap-4 px-6 md:px-12 lg:px-24 pb-0">
            ...
            <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2 text-xs uppercase tracking-widest font-medium text-white/50 font-heading">
                <span>&copy; {new Date().getFullYear()} Arogya BioX. All rights reserved.</span>
